 ...
 * 
 */
@WebServiceClient(name = "UserServiceService", targetNamespace = "http://services.ejb.javaee.lntormin.com/", wsdlLocation = "http://localhost:8080/EJBModule-ejb/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICESERVICE_QNAME = new QName("http://services.ejb.javaee.lntormin.com/", "UserServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EJBModule-ejb/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://services.ejb.javaee.lntormin.com/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.ejb.javaee.lntormin.com/", "UserServicePort"), UserService.class, features);
    }
